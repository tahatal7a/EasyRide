        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">123 Lees Ave, Ottawa, Canada</p>
              <p className="office__info">Phone: +16139999999</p>

              <p className="office__info">Email: carrentals@gmail.com</p>
